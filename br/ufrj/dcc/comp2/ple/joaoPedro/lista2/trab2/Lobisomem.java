 ...
 *
 * <h1>Classe de Lobisomem para o segundo exercicio, subclasse de Monstro.
...
public class Lobisomem extends Monstro {
   ...
   * @param  hp um int representando os pontos de vida de um lobisomem.
